...
TORCH_LIBRARY(nep, m) {
    m.def(
        ...
        {
            return ai2pot::nep::NepToEFOpCPU(
                (int)chebyshev_size,
                (int)n_radial_basis,
                (int)n_angular_basis,
                (int)l_max,
    ...
    m.def(
        ...
        [](int64_t chebyshev_size,
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            return ai2pot::nep::NepToEFVOpCPU(
                (int)chebyshev_size,
                (int)n_radial_basis,
                (int)n_angular_basis,
                (int)l_max,
    ...
    m.def(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::nep::NepToEFLossOpCPU(
                e_weight,
                f_weight,
                betot_dft_tensor,
                bforce_dft_tensor,
    ...
    m.def(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::nep::NepToLossOpCPU(
                e_weight,
                f_weight,
                v_weight,
                betot_dft_tensor,
    ...
    m.def(
        ...
        [](int64_t chebyshev_size,
           ...
           double rmax_angular)
        {
            return ai2pot::nep::NepToDescriptorsOpCPU(
                (int)chebyshev_size,
                (int)n_radial_basis,
                (int)n_angular_basis,
                (int)l_max,
...
TORCH_LIBRARY_IMPL(nep, AutogradCPU, m) {
    m.impl(
        "nepToEFLossOp",
        [](double e_weight,
           double f_weight,

...
torch::autograd::variable_list NepToEFFunctionCPU::forward(
...
torch::autograd::variable_list NepToEFFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
...
torch::autograd::variable_list NepToEFVFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
...
torch::autograd::variable_list NepToEFVFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {
...
torch::autograd::variable_list NepToEFLossFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    double e_weight,
    double f_weight,
...
torch::autograd::variable_list NepToEFLossFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
...
torch::autograd::variable_list NepToLossFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    double e_weight,
    double f_weight,
    double v_weight,
...
torch::autograd::variable_list NepToLossFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
    ...
    int n_radial_basis = ctx->get_saved_variables()[7].item<int>();
    int n_angular_basis = ctx->get_saved_variables()[8].item<int>();
    int l_max = ctx->get_saved_variables()[9].item<int>();
    at::Tensor coeffs_tensor = ctx->get_saved_variables()[10];
    at::Tensor w0_tensor = ctx->get_saved_variables()[11];
    at::Tensor b0_tensor = ctx->get_saved_variables()[12];
    at::Tensor w1_tensor = ctx->get_saved_variables()[13];
    at::Tensor type_bias_tensor = ctx->get_saved_variables()[14];
    ...
    double rmax_radial = ctx->get_saved_variables()[23].item<double>();
...
torch::autograd::variable_list NepToDescriptorsFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
...
torch::autograd::variable_list NepToDescriptorsFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {
...
torch::autograd::variable_list NepToEFOpCPU(
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
    int l_max,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFFunctionCPU::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,
...
torch::autograd::variable_list NepToEFVOpCPU(
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
    int l_max,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFVFunctionCPU::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,
...
torch::autograd::variable_list NepToEFLossOpCPU(
    double e_weight,
    double f_weight,
    const at::Tensor& betot_dft_tensor,
    const at::Tensor& bforce_dft_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFLossFunctionCPU::apply(
        e_weight,
        f_weight,
        betot_dft_tensor,
        bforce_dft_tensor,
...
torch::autograd::variable_list NepToLossOpCPU(
    double e_weight,
    double f_weight,
    double v_weight,
    const at::Tensor& betot_dft_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToLossFunctionCPU::apply(
        e_weight,
        f_weight,
        v_weight,
        betot_dft_tensor,
...
torch::autograd::variable_list NepToDescriptorsOpCPU(
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
    int l_max,
    ...
    double rmax_angular)
{
    return NepToDescriptorsFunctionCPU::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,

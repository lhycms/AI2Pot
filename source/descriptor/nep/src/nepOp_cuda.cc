...
torch::autograd::variable_list NepToEFFunctionCUDA::forward(
...
torch::autograd::variable_list NepToEFFunctionCUDA::backward(
    torch::autograd::AutogradContext *ctx,
...
torch::autograd::variable_list NepToEFVFunctionCUDA::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
...
torch::autograd::variable_list NepToEFVFunctionCUDA::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {
...
torch::autograd::variable_list NepToEFLossFunctionCUDA::forward(
    torch::autograd::AutogradContext *ctx,
    double e_weight,
    double f_weight,
...
torch::autograd::variable_list NepToEFLossFunctionCUDA::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
...
torch::autograd::variable_list NepToLossFunctionCUDA::forward(
    torch::autograd::AutogradContext *ctx,
    double e_weight,
    double f_weight,
    double v_weight,
...
torch::autograd::variable_list NepToLossFunctionCUDA::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
...
torch::autograd::variable_list NepToDescriptorsFunctionCUDA::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    int n_radial_basis,
    int n_angular_basis,
...
torch::autograd::variable_list NepToDescriptorsFunctionCUDA::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {
...
torch::autograd::variable_list NepToEFOpCUDA(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFFunctionCUDA::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,
...
torch::autograd::variable_list NepToEFVOpCUDA(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFVFunctionCUDA::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,
...
torch::autograd::variable_list NepToEFLossOpCUDA(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToEFLossFunctionCUDA::apply(
        e_weight,
        f_weight,
        betot_dft_tensor,
        bforce_dft_tensor,
...
torch::autograd::variable_list NepToLossOpCUDA(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return NepToLossFunctionCUDA::apply(
        e_weight,
        f_weight,
        v_weight,
        betot_dft_tensor,
...
torch::autograd::variable_list NepToDescriptorsOpCUDA(
    ...
    double rmax_angular)
{
    return NepToDescriptorsFunctionCUDA::apply(
        chebyshev_size,
        n_radial_basis,
        n_angular_basis,
        l_max,

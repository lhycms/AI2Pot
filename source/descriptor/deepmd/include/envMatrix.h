...
{   
    ...
    for (int ii=0; ii<inum; ii++) {
        for (int jj=0; jj<numneigh[ii]; jj++) {
            ...
            tilde_r[ii*umax_num_neigh_atoms*4 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4 + 0] = tilde_s_value;
            tilde_r[ii*umax_num_neigh_atoms*4 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4 + 1] = tilde_x_value;
            tilde_r[ii*umax_num_neigh_atoms*4 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4 + 2] = tilde_y_value;
            tilde_r[ii*umax_num_neigh_atoms*4 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4 + 3] = tilde_z_value;

            // Step 2.2. Deriv wrt. R_{ij} of EnvMatrix
            // Step 2.2.1. switch_func * 1/r_ij
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 0*3 + 0] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 0*3 + 1] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 0*3 + 2] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 1*3 + 0] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 1*3 + 1] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 1*3 + 2] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 2*3 + 0] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 2*3 + 1] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 2*3 + 2] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 3*3 + 0] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 3*3 + 1] = (
            ...
            tilde_r_deriv[ii*umax_num_neigh_atoms*4*3 + dp_firstneigh[ii*umax_num_neigh_atoms + jj]*4*3 + 3*3 + 2] = (

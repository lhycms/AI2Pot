...
// 2. find_ef
template void ai2pot::mtpr::find_ef_torch_launcher<float>(
    float *d_betot_ptr,
    float (*d_bforce)[3],
    int chebyshev_size,
    float *d_coeffs,
...
template void ai2pot::mtpr::find_ef_torch_launcher<double>(
    double *d_betot_ptr,
    double (*d_bforce)[3],
    int chebyshev_size,
    double *d_coeffs,
...
// 3. find_descriptors
template void ai2pot::mtpr::find_descriptors_torch_launcher<float>(
...
template void ai2pot::mtpr::find_descriptors_torch_launcher<double>(

...
torch::autograd::variable_list LinearMtpToLossFunctionCPU::forward(
...
torch::autograd::variable_list LinearMtpToLossFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
...
torch::autograd::variable_list LinearMtpToEFLossFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    double e_weight,
    double f_weight,
    const at::Tensor& betot_dft_tensor,
...
torch::autograd::variable_list LinearMtpToEFLossFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
...
torch::autograd::variable_list LinearMtpToEFVFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToEFVFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {at::Tensor(),
...
torch::autograd::variable_list LinearMtpToEFFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToEFFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {at::Tensor(),
...
torch::autograd::variable_list LinearMtpToEsitesFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToEsitesFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    // 0.
...
torch::autograd::variable_list LinearMtpToDescriptorsFunctionCPU::forward(
    torch::autograd::AutogradContext *ctx,
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToDescriptorsFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list bgrad_outputs_tensor)
{
    return {
...
torch::autograd::variable_list LinearMtpToLossOpCPU(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinearMtpToLossFunctionCPU::apply(
        e_weight,
        f_weight,
        v_weight,
        betot_dft_tensor,
...
torch::autograd::variable_list LinearMtpToEFLossOpCPU(
    double e_weight,
    double f_weight,
    const at::Tensor& betot_dft_tensor,
    const at::Tensor& bforce_dft_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinearMtpToEFLossFunctionCPU::apply(
        e_weight,
        f_weight,
        betot_dft_tensor,
        bforce_dft_tensor,
...
torch::autograd::variable_list LinearMtpToEFVOpCPU(
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
    const at::Tensor& linear_coeffs_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinearMtpToEFVFunctionCPU::apply(
        chebyshev_size,
        scaling,
        coeffs_tensor,
        linear_coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToEFOpCPU(
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
    const at::Tensor& linear_coeffs_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinearMtpToEFFunctionCPU::apply(
        chebyshev_size,
        scaling,
        coeffs_tensor,
        linear_coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToEsitesOpCPU(
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
    const at::Tensor& linear_coeffs_tensor,
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinearMtpToEsitesFunctionCPU::apply(
        chebyshev_size,
        scaling,
        coeffs_tensor,
        linear_coeffs_tensor,
...
torch::autograd::variable_list LinearMtpToDescriptorsOpCPU(
    int chebyshev_size,
    double scaling,
    const at::Tensor& coeffs_tensor,
    int alpha_moments_count,
    ...
    double rmin)
{
    return LinearMtpToDescriptorsFunctionCPU::apply(
        chebyshev_size,
        scaling,
        coeffs_tensor,
        alpha_moments_count,

...
torch::autograd::variable_list LinMatrixLinVectorFunctionCPU::forward(
...
torch::autograd::variable_list LinMatrixLinVectorFunctionCPU::backward(
    torch::autograd::AutogradContext *ctx,
...
torch::autograd::variable_list LinMatrixLinVectorOpCPU(
    ...
    const at::Tensor& zbl_dks_tensor)
{
    return LinMatrixLinVectorFunctionCPU::apply(
        e_weight,
        f_weight,
        v_weight,
        betot_dft_tensor,

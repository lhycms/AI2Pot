...
#ifndef AI2POT_MTPR_LINEAR_MTP_OP_CUDA_H
#define AI2POT_MTPR_LINEAR_MTP_OP_CUDA_H
...
class LinearMtpToLossFunctionCUDA : public torch::autograd::Function<LinearMtpToLossFunctionCUDA>
{
public:
...
};  // class : LinearMtpToLossFunctionCUDA


class LinearMtpToEFLossFunctionCUDA : public torch::autograd::Function<LinearMtpToEFLossFunctionCUDA>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : LinearMtpToEFLossFunctionCUDA


class LinearMtpToEFVFunctionCUDA : public torch::autograd::Function<LinearMtpToEFVFunctionCUDA>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : LinearMtpToEFVFunctionCUDA


class LinearMtpToEFFunctionCUDA : public torch::autograd::Function<LinearMtpToEFFunctionCUDA>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : LinearMtpToEFFunctionCUDA


class LinearMtpToEsitesFunctionCUDA : public torch::autograd::Function<LinearMtpToEsitesFunctionCUDA>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
...
};  // class : LinearMtpToEsitesFunctionCUDA


class LinearMtpToDescriptorsFunctionCUDA : public torch::autograd::Function<LinearMtpToDescriptorsFunctionCUDA>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : LinearMtpToDescriptorsCUDA

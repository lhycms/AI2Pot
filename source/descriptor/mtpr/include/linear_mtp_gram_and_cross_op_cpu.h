...
#ifndef AI2POT_MTPR_LINEAR_MTP_GRAM_AND_CROSS_OP_CPU_H
#define AI2POT_MTPR_LINEAR_MTP_GRAM_AND_CROSS_OP_CPU_H
...
class LinMatrixLinVectorFunctionCPU : public torch::autograd::Function<LinMatrixLinVectorFunctionCPU>
{
public:
...
};  // class : LinMatrixLinVectorFunctionCPU


torch::autograd::variable_list LinMatrixLinVectorOpCPU(
    double e_weight,
    double f_weight,
    double v_weight,
    const at::Tensor& betot_dft_tensor,

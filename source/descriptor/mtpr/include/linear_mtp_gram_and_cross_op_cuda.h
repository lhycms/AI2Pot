...
#ifndef AI2POT_MTPR_LINEAR_MTP_GRAM_AND_CROSS_OP_CUDA_H
#define AI2POT_MTPR_LINEAR_MTP_GRAM_AND_CROSS_OP_CUDA_H
...
class LinMatrixLinVectorFunctionCUDA : public torch::autograd::Function<LinMatrixLinVectorFunctionCUDA>
{
public:
...
};  // class : LinMatrixLinVectorFunctionCUDA

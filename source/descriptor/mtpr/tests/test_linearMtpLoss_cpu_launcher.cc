...
TEST_F(LinearMtpLossTest, find_ef_loss) {
    ai2pot::mtpr::find_ef_loss_cpu_launcher(
        bloss,
        batch_size,
        natoms_pad,
        binum,
...
TEST_F(LinearMtpLossTest, find_loss) {
    ai2pot::mtpr::find_loss_cpu_launcher(
        bloss,
        batch_size,
        natoms_pad,
        binum,
...
TEST_F(LinearMtpLossTest, find_ef_rmse_cpu_launcher) {
    double e_rmse;
    double f_rmse;

    ai2pot::mtpr::find_ef_rmse_cpu_launcher(
        e_rmse,
        f_rmse,
        batch_size,
        natoms_pad,
...
TEST_F(LinearMtpLossTest, find_efv_rmse_cpu_launcher) {
    double e_rmse;
    double f_rmse;
    double v_rmse;

    ai2pot::mtpr::find_efv_rmse_cpu_launcher(
        e_rmse,
        f_rmse,
        v_rmse,
        batch_size,

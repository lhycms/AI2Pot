...
class LinearMtpCPULauncher : public :: testing::Test
{
protected:
    int ntypes;
...
};  // class : LinearMtpCPULauncher


TEST_F(LinearMtpCPULauncher, find_efv_cpu_launcher) {
...
TEST_F(LinearMtpCPULauncher, find_ef_cpu_launcher) {
    int center_idx_modify = 1;
    int direction1_idx_modify = 2;
...
TEST_F(LinearMtpCPULauncher, find_descriptors_cpu_launcher) {
    int center_idx_modify = 1;
    int direction1_idx_modify = 2;

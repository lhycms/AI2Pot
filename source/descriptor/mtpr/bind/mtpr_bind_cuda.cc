...
TORCH_LIBRARY_IMPL(mtpr, CUDA, m) {
    m.impl(
        "CoeffsSchmidtOrthOp",
        [](int64_t ntypes,
           int64_t nmus,
           ...
           const at::Tensor& coeffs_tensor)
        {
            ...
            return ai2pot::mtpr::CoeffsSchmidtOrthOpCUDA(
                (int)ntypes,
                (int)nmus,
                (int)chebyshev_size,
                coeffs_tensor);
    ...
    m.impl(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::mtpr::LinMatrixLinVectorOpCUDA(
                e_weight,
                f_weight,
                v_weight,
                betot_dft_tensor,
    ...
    m.impl(
        ...
        {   
            ...
            return ai2pot::mtpr::LinearMtpToLossOpCUDA(
                e_weight,
                f_weight,
                v_weight,
                betot_dft_tensor,
    ...
    m.impl(
        ...
        {   
            ...
            return ai2pot::mtpr::LinearMtpToEFLossOpCUDA(
                e_weight,
                f_weight,
                betot_dft_tensor,
                bforce_dft_tensor,
    ...
    m.impl(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::mtpr::LinearMtpToEFVOpCUDA(
                (int)chebyshev_size,
                scaling,
                coeffs_tensor,
                linear_coeffs_tensor,
    ...
    m.impl(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::mtpr::LinearMtpToEFOpCUDA(
                (int)chebyshev_size,
                scaling,
                coeffs_tensor,
                linear_coeffs_tensor,
    ...
    m.impl(
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            ...
            return ai2pot::mtpr::LinearMtpToEsitesOpCUDA(
                (int)chebyshev_size,
                scaling,
                coeffs_tensor,
                linear_coeffs_tensor,
    ...
    m.impl(
           ...
           double rmin)
        {
            ...
            return ai2pot::mtpr::LinearMtpToDescriptorsOpCUDA(
                (int)chebyshev_size,
                scaling,
                coeffs_tensor,
                (int)alpha_moments_count,
...
TORCH_LIBRARY_IMPL(mtpr, AutogradCUDA, m) {
    m.impl(
        "CoeffsSchmidtOrthOp",
        [](int64_t ntypes,
           int64_t nmus,

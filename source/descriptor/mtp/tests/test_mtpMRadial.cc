...
TEST_F(MtpSwitchFunc1Test, copy_constructor) {
    distance_ij = 3.1;
    ai2pot::mtp::MtpSwitchFunc1<double> msf1(rcut, rcut_smooth);
    ai2pot::mtp::MtpSwitchFunc1<double> msf2(msf1);
}

TEST_F(MtpSwitchFunc1Test, assignment_operator) {
    distance_ij = 3.1;
    ai2pot::mtp::MtpSwitchFunc1<double> msf1(rcut, rcut_smooth);
    ai2pot::mtp::MtpSwitchFunc1<double> msf2(rcut-0.1, rcut_smooth);
    msf1 = msf2;
}

TEST_F(MtpSwitchFunc1Test, get_result_and_deriv2r) {
    distance_ij = 0.0;
    ai2pot::mtp::MtpSwitchFunc1<double> msf0(rcut, rcut_smooth);
    ...
    distance_ij = 3.1;
    ai2pot::mtp::MtpSwitchFunc1<double> msf2(rcut, rcut_smooth);
    ...
    distance_ij = 3.2;
    ai2pot::mtp::MtpSwitchFunc1<double> msf3(rcut, rcut_smooth);
...
{
    distance_ij = 3.1;
    ai2pot::mtp::MtpSwitchFunc2<double> msf1(rcut, rcut_smooth);
    ai2pot::mtp::MtpSwitchFunc2<double> msf2(msf1);
}
...
TEST_F(MtpSwitchFunc2Test, assignment_operator)
{
    distance_ij = 3.1;
    ai2pot::mtp::MtpSwitchFunc2<double> msf1(rcut, rcut_smooth);
    ai2pot::mtp::MtpSwitchFunc2<double> msf2(rcut-0.1, rcut_smooth);
    msf1 = msf2;
}

TEST_F(MtpSwitchFunc2Test, get_result_and_deriv2r) {
    distance_ij = 0.0;
    ai2pot::mtp::MtpSwitchFunc2<double> msf0(rcut, rcut_smooth);
    ...
    distance_ij = 3.05;
    ai2pot::mtp::MtpSwitchFunc2<double> msf2(rcut, rcut_smooth);
    printf("distance_ij = %5f, switch_func2_result = %6f, switch_func1_deriv2r = %6f\n", 
        distance_ij, 
        msf2.get_result(distance_ij),
    ...
    distance_ij = 3.2;
    ai2pot::mtp::MtpSwitchFunc2<double> msf3(rcut, rcut_smooth);
    printf("distance_ij = %5f, switch_func2_result = %6f, switch_func1_deriv2r = %6f\n", 
        distance_ij, 
        msf3.get_result(distance_ij),
...
TEST_F(ChebyshevPolyTest, build) 
{
    ...
    size = 8;
    ai2pot::mtp::ChebyshevPoly<double> chebyshev(size, rcut, rcut_smooth);
...
TEST_F(ChebyshevPolyTest, copy_constructor) 
{
    distance_ij = 3.05;
    size = 8;
    ai2pot::mtp::ChebyshevPoly<double> chebyshev1(size, rcut, rcut_smooth);
    chebyshev1.build(distance_ij);
    ai2pot::mtp::ChebyshevPoly<double> chebyshev2(chebyshev1);
    //chebyshev2.show();
    //chebyshev1.show();
...
TEST_F(ChebyshevPolyTest, copy_constructor_move)
{
    ...
    ai2pot::mtp::ChebyshevPoly<double> chebyshev1(size, rcut, rcut_smooth);
    chebyshev1.build(distance_ij);
    ai2pot::mtp::ChebyshevPoly<double> chebyshev2(std::move(chebyshev1));
    //chebyshev1.show();
    //chebyshev2.show();
...
TEST_F(ChebyshevPolyTest, assignment_operator)
{
    ...
    ai2pot::mtp::ChebyshevPoly<double> chebyshev1(size, rcut, rcut_smooth);
    chebyshev1.build(distance_ij);
    ai2pot::mtp::ChebyshevPoly<double> chebyshev2(size, rcut, rcut_smooth);
...
TEST_F(MtpQTest, build)
{
    size = 8;
    distance_ij = 3.05;
    ai2pot::mtp::MtpQ<double> mtp_q(size, rcut, rcut_smooth);
...
TEST_F(MtpQTest, copy_constructor)
{
    size = 8;
    distance_ij = 3.05;
    ai2pot::mtp::MtpQ<double> mtp_q_1(size, rcut, rcut_smooth);
    mtp_q_1.build(distance_ij);
    ai2pot::mtp::MtpQ<double> mtp_q_2(mtp_q_1);
    //mtp_q_1.show();
    //mtp_q_2.show();
...
TEST_F(MtpQTest, copy_constructor_move)
{
    ...
    ai2pot::mtp::MtpQ<double> mtp_q_1(size, rcut, rcut_smooth);
    mtp_q_1.build(distance_ij);
    ai2pot::mtp::MtpQ<double> mtp_q_2(std::move(mtp_q_1));
    //mtp_q_1.show();
    //mtp_q_2.show();
...
TEST_F(MtpQTest, assignment_operator)
{
    ...
    ai2pot::mtp::MtpQ<double> mtp_q_1(size, rcut, rcut_smooth);
    mtp_q_1.build(distance_ij);
    ai2pot::mtp::MtpQ<double> mtp_q_2(size, rcut-0.1, rcut_smooth);
    mtp_q_2 = mtp_q_1;
    //mtp_q_1.show();
    //mtp_q_2.show();
    for (int ii=0; ii<mtp_q_1.size(); ii++) {

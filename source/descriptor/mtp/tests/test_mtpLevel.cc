...
std::ostream& operator<<(
    std::ostream& COUT, 
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs)
{
    int count = 0;
...
{
    ai2pot::mtp::MtpMCoeffPair mcp;
    ASSERT_EQ(mcp.level(), 0);
}

TEST_F(MtpMCoeffPairTest, constructor_1)
{
    ai2pot::mtp::MtpMCoeffPair mcp(mu_0, nu_0);
...
{
    ai2pot::mtp::MtpMCoeffPair mcp(coeff_pair_0);
    //std::cout << mcp.level() << std::endl;
    ASSERT_EQ(mcp.level(), 8);
}
...
{
    ai2pot::mtp::MtpMCoeffPair mcp_1(coeff_pair_0);
    ai2pot::mtp::MtpMCoeffPair mcp_2(mcp_1);
...
{
    ai2pot::mtp::MtpMCoeffPair mcp_1(coeff_pair_0);
    ai2pot::mtp::MtpMCoeffPair mcp_2;
...
{
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs;
...
{
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_1(aim_level_6);
    //mcpcs_1.show();
    ASSERT_EQ(mcpcs_1.coeff_pair_combs().size(), 5);

    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_2(aim_level_8);
    //mcpcs_2.show();
    ASSERT_EQ(mcpcs_2.coeff_pair_combs().size(), 9);

    // Compare it with MLIP
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_6(6);
ASSERT_GE(mcpcs_6.coeff_pair_combs().size(), 5);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_8(8);
ASSERT_GE(mcpcs_8.coeff_pair_combs().size(), 9);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_10(10);
ASSERT_GE(mcpcs_10.coeff_pair_combs().size(), 16);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_12(12);
ASSERT_GE(mcpcs_12.coeff_pair_combs().size(), 29);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_14(14);
//mcpcs_14.show();
ASSERT_GE(mcpcs_14.coeff_pair_combs().size(), 52);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_16(16);
ASSERT_GE(mcpcs_16.coeff_pair_combs().size(), 92);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_18(18);
ASSERT_GE(mcpcs_18.coeff_pair_combs().size(), 163);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_20(20);
ASSERT_GE(mcpcs_20.coeff_pair_combs().size(), 288);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_22(22);
ASSERT_GE(mcpcs_22.coeff_pair_combs().size(), 500);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_24(24);
ASSERT_GE(mcpcs_24.coeff_pair_combs().size(), 864);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_26(26);
ASSERT_GE(mcpcs_26.coeff_pair_combs().size(), 1464);
    ai2pot::mtp::MtpMCoeffPairCombs mcpcs_28(28);
ASSERT_GE(mcpcs_28.coeff_pair_combs().size(), 2445);
}

TEST_F(MtpMCoeffPairCombsTest, copy_constructor)
{
    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_6(max_level_6);
    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_6_(coeff_pair_combs_6);

    for (int ii=0; ii<coeff_pair_combs_6.coeff_pair_combs().size(); ii++) {
        std::vector<ai2pot::mtp::MtpMCoeffPair> tmp_coeff_pair_comb_6 = 
            coeff_pair_combs_6.coeff_pair_combs()[ii];
        std::vector<ai2pot::mtp::MtpMCoeffPair> tmp_coeff_pair_comb_6_ = 
...
{
    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_6(max_level_6);
    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_8(max_level_8);
    ...
    for (int ii=0; ii<coeff_pair_combs_6.coeff_pair_combs().size(); ii++)
    {
        std::vector<ai2pot::mtp::MtpMCoeffPair> tmp_coeff_pair_comb_6 = 
            coeff_pair_combs_6.coeff_pair_combs()[ii];
        std::vector<ai2pot::mtp::MtpMCoeffPair> tmp_coeff_pair_comb_8 = 
...
{
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> combs_0 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_0, 0, 0);
    ASSERT_EQ(combs_0.size(), 1);   // Contains empty scheme.

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> combs_1 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_1, 0, 0);
    ASSERT_EQ(combs_1.size(), 0);

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> combs_6 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_6, 0, 0);
//std::cout << combs_6 << std::endl;
    ASSERT_EQ(combs_6.size(), 5);   // Contains empty scheme.

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> combs_8 =
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_8, 0, 0);
//std::cout << combs_8 << std::endl;
    ASSERT_EQ(combs_8.size(), 9);

    // Note 检查是否包含 [0, 2], [1, 1], [0, 1]
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> combs_14 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_14, 0, 0);
...
{
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs_0 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_0, 0, 0);
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> contracted_coeff_pair_combs_0 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_contracted_combs(coeff_pair_combs_0);
//std::cout << contracted_coeff_pair_combs_0 << std::endl;
    ASSERT_EQ(contracted_coeff_pair_combs_0.size(), 0);

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs_1 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_1, 0, 0);
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> contracted_coeff_pair_combs_1 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_contracted_combs(coeff_pair_combs_1);
//std::cout << contracted_coeff_pair_combs_1 << std::endl;
    ASSERT_EQ(contracted_coeff_pair_combs_1.size(), 0);;

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs_6 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_6, 0, 0);
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> contracted_coeff_pair_combs_6 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_contracted_combs(coeff_pair_combs_6);
//std::cout << contracted_coeff_pair_combs_6 << std::endl;
    ASSERT_EQ(contracted_coeff_pair_combs_6.size(), 3);

    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs_8 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_8, 0, 0);
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> contracted_coeff_pair_combs_8 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_contracted_combs(coeff_pair_combs_8);
//std::cout << contracted_coeff_pair_combs_8 << std::endl;
    ASSERT_EQ(contracted_coeff_pair_combs_8.size(), 4);

    // Note 检查是否包含 [0, 2], [1, 1], [0, 1]
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> coeff_pair_combs_14 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_all_schemes4lev(aim_level_14, 0, 0);
    std::vector<std::vector<ai2pot::mtp::MtpMCoeffPair>> contracted_coeff_pair_14 = 
        ai2pot::mtp::MtpMCoeffPairCombs::get_contracted_combs(coeff_pair_combs_14);
...
TEST_F(MtpMCoeffPairCombsTest, nmus)
{
    ...
    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_14(max_level_14);
    ASSERT_EQ(coeff_pair_combs_14.nmus(), coeff_pair_combs_14.nmus_check());

    ai2pot::mtp::MtpMCoeffPairCombs coeff_pair_combs_28(max_level_28);

...
#include "../include/efv_rmse_cpu_launcher.h"


class EFVRmseCPULauncherTest : public ::testing::Test
{
protected:
    int batch_size;
    int natoms_pad;
    ...
    static void SetUpTestSuite() {
        std::cout << "EFVRmseCPULauncherTest (TestSuite) is setting up...\n";
    }

    static void TearDownTestSuite() {
        std::cout << "EFVRmseCPULauncherTest (TestSuite) is tearing down...\n";
    }
...
};  // class : EFVRmseCPULauncherTest


TEST_F(EFVRmseCPULauncherTest, find_ef_rmse_cpu_launcher) {
    double e_rmse;
    double f_rmse;

    ai2pot::fitutils::find_ef_rmse_cpu_launcher(
        e_rmse,
        f_rmse,
        batch_size,
        natoms_pad,
...
TEST_F(EFVRmseCPULauncherTest, find_efv_rmse_cpu_launcher) {
    double e_rmse;
    double f_rmse;
    double v_rmse;

    ai2pot::fitutils::find_efv_rmse_cpu_launcher(
        e_rmse,
        f_rmse,
        v_rmse,
        batch_size,

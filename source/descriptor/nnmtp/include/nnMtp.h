...
template <typename CoordType>
void NNMtp<CoordType>::find_ef_loss_backward(
    CoordType *loss_der2coeffs,
    CoordType *loss_der2w0,
    CoordType *loss_der2w1,
    CoordType *loss_der2type_bias,
    ...
    CoordType *zbl_dks)
{
    ...
    memset(force_ml, 0.0, sizeof(CoordType) * (inum+nghost) * 3);
    find_ef(
        etot_ml,
        force_ml,
        chebyshev_size,
...
template <typename CoordType>
void NNMtp<CoordType>::find_loss_backward(
    CoordType *loss_der2coeffs,
    CoordType *loss_der2w0,
    CoordType *loss_der2w1,
    CoordType *loss_der2type_bias,
    ...
    CoordType *zbl_dks)
{
    ...
    memset(virial_ml, 0.0, sizeof(CoordType) * 9);
    find_efv(
        etot_ml,
        force_ml,
        virial_ml,

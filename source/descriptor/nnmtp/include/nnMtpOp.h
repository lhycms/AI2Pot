...
#ifndef AI2POT_NNMTP_NNMTP_OP_H
#define AI2POT_NNMTP_NNMTP_OP_H
...
class NNMtpToEFLossFunction : public torch::autograd::Function<NNMtpToEFLossFunction>
{
public:
...
class NNMtpToEFFunction : public torch::autograd::Function<NNMtpToEFFunction>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : NNMTtpToEFFunction


class NNMtpToEFVFunction : public torch::autograd::Function<NNMtpToEFVFunction>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,
    ...
    static torch::autograd::variable_list backward(
        torch::autograd::AutogradContext *ctx,
        torch::autograd::variable_list bgrad_outputs_tensor);
};  // class : NNMTtpToEFVFunction


class NNMtpToDescriptorsFunction : public torch::autograd::Function<NNMtpToDescriptorsFunction>
{
public:
    static torch::autograd::variable_list forward(
        torch::autograd::AutogradContext *ctx,

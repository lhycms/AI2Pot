...
#ifndef AI2POT_NNMTP_NNMTP_LOSS_CPU_LAUNCHER_H
#define AI2POT_NNMTP_NNMTP_LOSS_CPU_LAUNCHER_H
...
template <typename CoordType>
void find_ef_loss_cpu_launcher(
    CoordType *bloss,
    int batch_size,
    int natoms_pad,
    int *binum,
    ...
    CoordType (*bforce_dft)[3])
{
    for (int bb=0; bb<batch_size; bb++) {
        ...
        NNMtpLoss<CoordType>::find_ef_loss(
            *loss_ptr,
            inum,
            ilist,
            e_weight,
...
template <typename CoordType>
void find_loss_backward_cpu_launcher(
    CoordType *bloss_der2coeffs,
    CoordType *bloss_der2w0,
    CoordType *bloss_der2b0,
    CoordType *bloss_der2w1,
    ...
    CoordType *q_scaler)
{
    ...
    for (int bb=0; bb<batch_size; bb++) {
        ...
        CoordType *loss_der2w0 = &bloss_der2w0[bb*(ntypes*num_neurons*alpha_scalar_moments)];
...
template <typename CoordType>
void find_ef_loss_backward_cpu_launcher(
    CoordType *bloss_der2coeffs,
    CoordType *bloss_der2w0,
    CoordType *bloss_der2b0,
    CoordType *bloss_der2w1,

...
TORCH_LIBRARY_IMPL(nnmtp, CUDA, m) {
    m.impl(
        "nnMtpToEFLossOp",
        [](double e_weight,
           double f_weight,
        ...
        {
            return ai2pot::nnmtp::NNMtpToEFLossOpCUDA(
                e_weight,
                f_weight,
                betot_dft_tensor,
                bforce_dft_tensor,
    ...
    m.impl(
        ...
        [](double e_weight,
           ...
           const at::Tensor& zbl_dks_tensor) 
        {
            return ai2pot::nnmtp::NNMtpToLossOpCUDA(
                e_weight,
                f_weight,
                v_weight,
                betot_dft_tensor,
    ...
    m.impl(
        ...
        [](int64_t chebyshev_size,
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            return ai2pot::nnmtp::NNMtpToEFOpCUDA(
                (int)chebyshev_size,
                coeffs_tensor,
                w0_tensor,
                b0_tensor,
    ...
    m.impl(
        ...
        [](int64_t chebyshev_size,
           ...
           const at::Tensor& zbl_dks_tensor)
        {
            return ai2pot::nnmtp::NNMtpToEFVOpCUDA(
                (int)chebyshev_size,
                coeffs_tensor,
                w0_tensor,
                b0_tensor,
    ...
    m.impl(
        ...
        [](int64_t chebyshev_size,
           ...
           double rmin)
        {
            return ai2pot::nnmtp::NNMtpToDescriptorsOpCUDA(
                (int)chebyshev_size,
                coeffs_tensor,
                (int)alpha_moments_count,
                alpha_index_basic_tensor,
...
TORCH_LIBRARY_IMPL(nnmtp, AutogradCUDA, m) {
    m.impl(
        "nnMtpToEFLossOp",
        [](double e_weight,
           double f_weight,

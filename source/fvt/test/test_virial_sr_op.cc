...
class VirialSrOpTest : public ::testing::Test
{
protected:
    ...
    static void TearDownTestSuite() {
        std::cout << "VirialSrOpTest (TestSuite) is tearing down...\n";
    }
    ...
    void SetUp() override {
        ...
        firstneigh = bfirstneigh_tensor.data_ptr<int>();
...
};  // class : VirialSrOpTest


TEST_F(VirialSrOpTest, backward_for_der1) {
    ...
    at::Tensor bvirial_sr_tensor = matersdk::fvt::VirialSrOp(
        ...
        umax_num_neighs,
        bdei_drij_tensor)[0];
    bvirial_sr_tensor.sum().backward();
    at::Tensor der1_tensor = bdei_drij_tensor.grad().index({0,
                                                            center_idx_modify,
                                                            neighbor_idx_modify,
                                                            direction_idx_modify});
std::cout << bvirial_sr_tensor << std::endl;
std::cout << der1_tensor << std::endl;
    ...
    at::Tensor bvirial_sr_tensor_ = matersdk::fvt::VirialSrOp(
        ...
        umax_num_neighs,
        bdei_drij_tensor)[0];
std::cout << bvirial_sr_tensor_ << std::endl;
std::cout << (bvirial_sr_tensor_.sum() - bvirial_sr_tensor.sum()) / 0.001 << std::endl;
}

TEST_F(VirialSrOpTest, backward_for_der2) {

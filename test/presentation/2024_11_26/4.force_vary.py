...
for i in range(100):
    ...
    f_wgt = f_wgt_stop * (1 - current_lr / lr_start) + f_wgt_start * current_lr / lr_start
    f_wgts.append(f_wgt)
    schedular.step()
...
plt.ylabel("Force weight", fontsize=35, 
        fontweight="bold"
        )
...
plt.savefig("/data/home/liuhanyu/hyliu/code/rubbish/test/AI2Pot/test/presentation/2024_11_26/f_weight.png",

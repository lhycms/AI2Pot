...
if __name__ == "__main__":
    ...
    system = "ReNbSTe"
    mc_x = "mc_5_491"
    poscar_path: str = "/data/home/liuhanyu/hyliu/code/rubbish/test/AI2Pot/test/ReNbSTe_sro_bader/input_data/{0}/CONTCARs/{1}/CONTCAR".format(system, mc_x)
    acf_dat_path = "/data/home/liuhanyu/hyliu/code/rubbish/test/AI2Pot/test/ReNbSTe_sro_bader/input_data/{0}/bader/{1}/ACF.dat".format(system, mc_x)
    # atomic numbers : [75, 41, 16, 52]
    elements_lst = ["Re", "Nb", "S", "Te"]
    charges_origin_lst = [7, 13, 6, 6]
    num_atoms_lst = [18, 18, 36, 36]
    
    # Part 2.
    cutoff: float = 4.8 # 4.8 for metal. 3.2 for S/Te.
    ...
    print("/data/home/liuhanyu/hyliu/code/rubbish/test/AI2Pot/test/ReNbSTe_sro_bader/output/{0}/{1}_{2}.csv".format(mc_x, center_type, neigh_type))
    df.to_csv("/data/home/liuhanyu/hyliu/code/rubbish/test/AI2Pot/test/ReNbSTe_sro_bader/output/{0}/{1}_{2}.csv".format(mc_x, center_type, neigh_type))

...
df = pd.read_csv("/data/home/liuhanyu/mycode/AI2Pot/lightning_logs/lightning_logs/version_12/metrics.csv")
print(df)
...
print(df.loc[df["train/f_rmse_epoch"].notna(), ["epoch", "train/f_rmse_epoch"]])
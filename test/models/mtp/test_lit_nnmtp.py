...
class LitNNMtpTest(unittest.TestCase):
    def setUp(self):
        print("LitNNMtp (TestCase) is setting up...\n")
        ...
        self.lit_nn_mtp: LitNNMtp = LitNNMtp(
            type_map=type_map,
            ...
            zbl_rmax=0.0,
            zbl_typewise_factor=0.7).to(torch_float_dtype)
        ...
        self.nn_mtp_descriptor_norm_callback: NNMtpDescriptorNormCallback = NNMtpDescriptorNormCallback()
        ...
        self.trainer: L.Trainer = L.Trainer(
            ...
            log_every_n_steps=1,
            callbacks=[
                self.nn_mtp_descriptor_norm_callback,
                self.energy_shift_callback
                ])

    
    def tearDown(self):
        print("LitNNMtp (TestCase) is tearing down...\n")

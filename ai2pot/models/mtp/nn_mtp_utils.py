...
class NNMtpCalculator(Calculator):
    ...
    def __init__(self,
        ...
        self.lit_linear_mtp: LitNNMtp = LitNNMtp.load_from_checkpoint(checkpoint_path=self.checkpoint_path,
                                                                              map_location=map_location)
        self.has_virial: bool = self.lit_linear_mtp.model.fit_virial
        self.torch_float_dtype: torch._C.dtype = torch_float_dtype

        # model and data
        self.linear_mtp: LitNNMtp = self.lit_linear_mtp.model.to(torch_float_dtype)
...
class NNMtp4Extxyz(object):
    def __init__(self,
        ...
        # model and data
        self.linear_mtp: NNMtp = self.lit_linear_mtp.model.to(torch_float_dtype)

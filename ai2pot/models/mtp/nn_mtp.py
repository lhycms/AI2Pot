...
class NNMtp(nn.Module):
    ...
    def predict_loss(self,
        ...
        #
        bmse_tensor, e_rmse_tensor, f_rmse_tensor, v_rmse_tensor = nnMtpToLossOp(
            e_weight,
            f_weight,
            v_weight,
    ...
    def predict_ef_loss(self,
        ...
        #
        bmse_tensor, e_rmse_tensor, f_rmse_tensor = nnMtpToEFLossOp(
            e_weight,
            f_weight,
            betot_dft_tensor_norm,
            bforce_dft_tensor_norm,
    ...
    def predict_efv(self,
        ...
        #
        betot_tensor, bforce_tensor, bvirial_tensor = torch.ops.nnmtp.nnMtpToEFVOp(
            self.chebyshev_size,
            self.coeffs_tensor,
            self.w0_tensor,
            self.b0_tensor,
    ...
    def predict_ef(self,
        ...
        #
        betot_tensor, bforce_tensor= torch.ops.nnmtp.nnMtpToEFOp(
            self.chebyshev_size,
            self.coeffs_tensor,
            self.w0_tensor,
            self.b0_tensor,
